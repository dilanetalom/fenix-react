    ...
    <div className='w-full lg:h-[215px] orangebackcolor text-white'>
      ...
      <div className='lg:w-[500px] flex flex-col gap-2'>
       ...
       <div className='flex lg:flex-row flex-col gap-5 items-center'>
              <input type="text" className='outline-none w-full border-b-[0.1px] border-white orangebackcolor text-[12px] text-white placeholder-white placeholder-opacity-45' placeholder='Entrer votre email'/>
